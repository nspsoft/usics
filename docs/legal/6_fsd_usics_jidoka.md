...
**Nama Proyek:** Implementasi Sistem USICS  
**Klien:** PT. Jidoka Result Indonesia  
**Pengembang:** Developer USICS  
...
Tabel di bawah ini memuat daftar fungsionalitas aplikasi web Sistem USICS yang wajib dikembangkan dan diserah-terimakan.
...
2. Pendaftaran Domain nama perusahaan selain subdomain dari Developer USICS.
3. Desain UI Aplikasi Mobile (Android/iOS) Native khusus (Sistem USICS hanya berupa Web-App yang responsif diakses dari browser HP).
