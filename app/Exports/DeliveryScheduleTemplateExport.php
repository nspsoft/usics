    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $instructionSheet->setCellValue('A11', 'Product SKU *');
                $instructionSheet->setCellValue('B11', 'Wajib. Kode SKU produk, harus sama dengan master product.');
                $instructionSheet->setCellValue('A12', 'Product Name');
                $instructionSheet->setCellValue('B12', 'Opsional. Hanya referensi tampilan.');
                $instructionSheet->setCellValue('A13', 'Qty *');
                $instructionSheet->setCellValue('B13', 'Wajib. Qty jadwal pengiriman. Harus angka ≥ 0.');
                $instructionSheet->setCellValue('A14', 'Delivery Date *');
                $instructionSheet->setCellValue('B14', 'Wajib. Tanggal delivery, format YYYY-MM-DD atau tanggal Excel.');
