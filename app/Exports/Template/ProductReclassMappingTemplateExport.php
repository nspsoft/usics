...
class ProductReclassMappingTemplateExport implements FromCollection, WithHeadings, WithEvents
{
    public function collection()
    {
        return collect([
            [
                'RM-STEEL-001', // Source SKU
                'FG-TABLE-001', // Target SKU
                'Yes',          // Is Active
                'Yes',          // Is Default
                'Notes untuk mapping ini', // Notes
            ]
        ]);
    }
