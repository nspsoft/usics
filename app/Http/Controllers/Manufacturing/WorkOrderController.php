...
class WorkOrderController extends Controller
{
    ...
    public function recordProductionForm(WorkOrder $workOrder): Response
    {
        ...
        $workOrder->load(['product', 'bom', 'components.product', 'outputs.product']);

        // Fetch available inventory lots for the components (Mother Coils)
        $componentProductIds = $workOrder->components->pluck('product_id');
        $availableLots = \App\Models\InventoryLot::query()
