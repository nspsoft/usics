...
const submit = () => {
    form.post(route('ga.assets.store'));
};
</script>

<template>
    <Head title="Tambah Aset (GA)" />
    ...
    <AppLayout title="Tambah Aset">
        <div class="mx-auto max-w-4xl">
            <div class="mb-6 flex items-center gap-4">
                ...
                <h2 class="text-xl font-black text-slate-900 dark:text-white">Tambah Aset Baru</h2>
            </div>
            ...
            <div class="glass-card rounded-3xl p-6 shadow-sm">
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input v-model="form.asset_code" type="text" required class="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white" placeholder="Contoh: AST-001" />
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input v-model="form.location" type="text" class="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white" placeholder="Contoh: Meja Resepsionis" />
                            </div>
                            <div>
                    ...
                    <div class="border-t border-slate-200 pt-6 dark:border-slate-800">
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300">Foto Aset</label>
